 ...
 * @author jasonthomasgray / http://github.com/jasonthomasgray
 */
...
const EditorControls = function ( object, domElement ) {
    ...
    var STATE = { NONE: -1, ROTATE: 0, ZOOM: 1, PAN: 2, SELECT: 3 };
    ...
    function onMouseMove( event ) {
        ...
        if ( state === STATE.ROTATE ) {
            ...
            // only select if mouse doesn't move too far
            var delta = movementX * movementX + movementY * movementY;
            if (delta > 16) {
                state = STATE.NONE;
            }
            else {
